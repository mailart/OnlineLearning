              ...
              <div class="panel home-panel-1">
                <div class="row">
                  <div class="large-6 small-8 columns small-centered large-centered">
                    <h5 class="hide-for-large-up"><a href="//www.humber.ca/onlinelearning/livesupport/phplive.php?d=1&onpage=livechatimagelink&title=Live+Chat+Image+Link" target="new">Chat with a Student Support Advisor</a></h5>
                    <img src="images/home/chat.png" alt="Chat with a Student Support Advisor" />
                  </div>
                  <div class="large-12 small-8 columns small-centered large-uncentered">
                    <h5 class="hide-for-small-only hide-for-medium-only"><a href="chat.html" target="new">Chat with a Student Support Advisor</a></h5>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="side-bar large-3 columns">
          <div class="panel">
            ...
            <div class="status-box status-normal radius">
              ...
              <!--<p><a href="contact.php">The OLC will be closed at 6:30pm on Friday June 27th, and will remain closed on June 30th and July 1st, 2014 for Canada Day.</a></p>-->
            </div>
          </div>
