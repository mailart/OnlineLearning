...
<body>
          ...
          <div class="row">
            <div class="large-12 columns">
              ...
              <ul class="featured-items" data-orbit>
                <li>
                  <a href="courses.php"><img src="images/home/banner-login.jpg" alt="slide 1" /></a>
                </li>
                <li>
                  <a href="#" data-reveal-id="virtual-proctoring"><img src="images/home/banner-virtual.jpg" alt="slide 2" /></a>
                </li>
                <li>
                  <a href="proctor.php"><img src="images/home/banner-proctor.jpg" alt="slide 3" /></a>
                </li>
                <li>
                  <a href="courses.php" data-reveal-id="teaching-trainer"><img src="images/home/banner-teacher.jpg" alt="slide 4" /></a>
                </li>
                <li>
                  <a href="#" data-reveal-id="computer-basic"><img src="images/home/banner-computer.jpg" alt="slide 5" /></a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="large-4 medium-4 small-12 columns">
              <div class="panel home-panel-2">
                <div class="row">
                  <div class="large-6 small-8 columns small-centered large-centered">
                    <h5 class="hide-for-large-up">Blackboard Learn 9.1 Student Help</h5>
                    <img src="images/blackboard_logo.png" alt="Blackboard Logo" />
                  </div>
                  <div class="large-12 small-8 columns small-centered large-uncentered">
                    <h5 class="hide-for-small-only hide-for-medium-only">Blackboard Learn 9.1 Student Help</h5>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="side-bar large-3 columns">
          <div class="panel">
            ...
            <div class="status-box status-normal radius">
              <h5>OLC Status</h5>
             <!-- <p><a href="contact.php">Humber College OLC will be CLOSED on Friday April 3rd, 2015 for Good Friday. We will be open on Saturday and Sunday.</a></p>-->
  ...
  <div id="computer-basic" class="reveal-modal medium" data-reveal>
    <h3>Computer Basic</h3>
    <div class="basic-computer">
      <ul >
        <li>
          <a href="./download/Brochure-wordpressing-windows-WEB-PW.pdf" target="_blank"><img src="images/home/ICONS-WP-and_Windows.png" alt="slide 1" /></a>
        </li>
        <li>
          <a href="./download/Brochure-Keyboard-skills-WEB-PW.pdf"  target="_blank"><img src="images/home/ICONS-Keyboarding-Skills.png" alt="slide 2" /></a>
        </li>
        <div style="clear:both"></div>
      </ul>
      <ul class="row2">
        <li>
          <a href="./download/Brochure-essentials-wordprocessing-WEB-PW.pdf"  target="_blank"><img src="images/home/ICONS-Word-Processing.png" alt="slide 3" /></a>
        </li>
        <li>
          <a href="./download/Brochure-essentials-spreadsheets-WEB-PW.pdf"  target="_blank"><img src="images/home/ICONS-Sreadsheets.png" alt="slide 4" /></a>
        </li>
        <div style="clear:both"></div>
      </ul>
    </div>
  ...
  <div id="teaching-trainer" class="reveal-modal medium" data-reveal>
    <h3>Teaching Trainer</h3>
    <div class="basic-Teaching">
